...
public class DragAndDropCell : MonoBehaviour, IDropHandler
{
    ...
    //Reference to the display of this slot's item
    ...
    //Reference to the unit controlling this cell.
    protected DummyControlUnit myControlUnit;
	...
	private void PlaceItem(DragAndDropItem item)
	{
		...
		if (item != null)
		{
			...
			myDadItem = item;
            myControlUnit.checkItem(myDadItem.getItemReference(), this);
    ...
    /// <summary>
	/// Updates the data of the item in this cell.
	/// </summary>
    public void UpdateItemData(InventoryUI bankRef)
    {
        if (myDadItem != null)
        {
            myDadItem.UpdateItemPlain(bankRef);
        }
    }
	...
	public void UpdateMyItem()
	{
        ...
        if (myDadItem != null)
        {
            ...
            Image myImage = myDadItem.GetComponent<Image>();
            if (myImage != null)
            {
                myImage.color = new Color(myImage.color.r, myImage.color.b, myImage.color.g, 1f);
                OrbotaItem itemReference = myDadItem.getItemReference();
    ...
    /// <summary>
	/// Sets the cell's control unit.
	/// </summary>
	/// <param name="firstCell"> Cell </param>
    public void setControlUnit(DummyControlUnit newUnit)
    {
        myControlUnit = newUnit;
    }
}
