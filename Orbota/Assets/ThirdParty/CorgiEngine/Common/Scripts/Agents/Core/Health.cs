...
namespace MoreMountains.CorgiEngine
{
	...
	public class Health : MonoBehaviour
	{
	    ...
	    public virtual void ResetHealthToMaxHealth()
	    {
			...
			////Jared - Reset color of healthbar.
			//Image healthbar = GameObject.FindGameObjectWithTag("Health").GetComponent<Image>();
			//if (healthbar != null) {
			//	healthbar.color = new Color32 (0, 207, 255, 255);
			//}
			UpdateHealthBar (false);
	    }	
		...
		protected virtual void UpdateHealthBar(bool show)
	    {
	    	...
	    	if (_character != null)
	    	{
	    		if (_character.CharacterType == Character.CharacterTypes.Player)
	    		{
     //               //Jared's addition - Change health bar fill amount & color when needed.
     //               Image healthbar = GameObject.FindGameObjectWithTag("Health").GetComponent<Image>();
     //               if (healthbar != null)
     //               {
     ...
     //               Text healthtext = GameObject.FindGameObjectWithTag("HealthText").GetComponent<Text> ();
					//if (healthtext != null) {
					//	healthtext.text = (((float)CurrentHealth / InitialHealth)*100f) + "%";
					//}
