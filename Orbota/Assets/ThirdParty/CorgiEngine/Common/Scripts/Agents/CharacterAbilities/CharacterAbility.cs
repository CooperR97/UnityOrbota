...
{	
	...
	public class CharacterAbility : MonoBehaviour 
	{
        ...
        protected virtual void pitchShift(float pitch)
        {
            //Debug.Log("Attempting pitch shift"); // +  _abilityInProgressSfx.clip.name);
            //Debug.Log("SFX is: " + base._abilityInProgressSfx);
            if (_abilityInProgressSfx != null && _abilityInProgressSfx.pitch != pitch)
            {
                //Debug.Log("Shifting");
                _abilityInProgressSfx.pitch = pitch;
            }
        }
