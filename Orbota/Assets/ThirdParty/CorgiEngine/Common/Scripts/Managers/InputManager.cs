...
{	
	...
	public class InputManager : Singleton<InputManager>
	{
		...
		public MMInput.IMButton InventoryButton { get; protected set; }
		...
		protected virtual void InitializeButtons()
		{
            ...
            ButtonList.Add(InventoryButton = new MMInput.IMButton(PlayerID, "Inventory", InventoryButtonDown, InventoryButtonPressed, InventoryButtonUp));
        }
        ...
        public virtual void InventoryButtonDown() { InventoryButton.State.ChangeState(MMInput.ButtonStates.ButtonDown); }
        public virtual void InventoryButtonPressed() { InventoryButton.State.ChangeState(MMInput.ButtonStates.ButtonPressed); }
        public virtual void InventoryButtonUp() { InventoryButton.State.ChangeState(MMInput.ButtonStates.ButtonUp); }
